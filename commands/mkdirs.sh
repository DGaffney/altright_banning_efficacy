...
mkdir $(pwd)/baumgartner_data/machine_learning_resources
mkdir $(pwd)/baumgartner_data/machine_learning_results
mkdir $(pwd)/baumgartner_data/machine_learning_results_aggregated