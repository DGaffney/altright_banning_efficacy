...
models = []
for model_file in os.popen("ls "+path+"/"+dataset+"_neural_net_voter_*").read().split("\n")[:args["count"]]:
  if model_file != '':
    models.append(load_model(model_file))

file_scores = {}
#Originall coded in https://docs.google.com/spreadsheets/d/1lMgnAvokvdRw1OTRqrsw-jpcMc8hCzBm_pcxf-235ks/edit#gid=0
